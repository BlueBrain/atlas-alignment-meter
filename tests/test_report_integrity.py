...
def test_report_integrity():
  ...
  assert metrics["global"]["min"] >= 0 and metrics["global"]["min"] <= 1
  assert metrics["global"]["max"] >= 0 and metrics["global"]["max"] <= 1
  assert metrics["global"]["median"] >= 0 and metrics["global"]["median"] <= 1
  assert metrics["global"]["mean"] >= 0 and metrics["global"]["mean"] <= 1
  assert metrics["global"]["std"] >= 0 and metrics["global"]["std"] <= 1
